  ...
  return (
    <div className="bg-safaridark min-h-screen py-12">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <section>
            ...
            <div className="rounded-xl border border-safariborder bg-safarigray p-8">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-lg bg-safarigray/50 p-4">
                  <h3 className="font-semibold mb-3">Smartphones & Tablets</h3>
                  <p className="text-gray-400">12 months manufacturer warranty</p>
                </div>
                <div className="rounded-lg bg-safarigray/50 p-4">
                ...
                <div className="rounded-lg bg-safarigray/50 p-4">
                  ...
                  <p className="text-gray-400">6-12 months manufacturer warranty</p>
                </div>
                <div className="rounded-lg bg-safarigray/50 p-4">
                  <h3 className="font-semibold mb-3">Accessories</h3>
                  <p className="text-gray-400">3-6 months manufacturer warranty</p>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Faulty components, assembly defects, hardware malfunctions occurring under normal use</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <span className="text-green-500 text-xl">✅</span>
                  <div>
                    ...
                    <p className="text-gray-400">Device not performing to manufacturer specifications</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <span className="text-green-500 text-xl">✅</span>
                  <div>
                    ...
                    <p className="text-gray-400">Devices that won't power on or have severe battery degradation (for eligible items)</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Cracked screens, dents, water damage, drops, or any physical damage</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <span className="text-red-500 text-xl">❌</span>
                  <div>
                    ...
                    <p className="text-gray-400">Devices opened or repaired by unauthorized service providers</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <span className="text-red-500 text-xl">❌</span>
                  <div>
                    ...
                    <p className="text-gray-400">Cosmetic damage, minor scratches, or degradation from normal use</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <span className="text-red-500 text-xl">❌</span>
                  <div>
                    ...
                    <p className="text-gray-400">Problems caused by unauthorized software, jailbreaking, or unsupported modifications</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">WhatsApp +254 700 000 000 or email hello@safaritech.co.ke with your order ID and product details.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Provide detailed description of the problem, when it started, and any troubleshooting you've done.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Our team will assess your case and provide a Return Merchandise Authorization (RMA) number if eligible.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">We'll arrange free pickup of the item. Repairs typically take 7-14 business days.</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="mt-16 text-center rounded-xl border border-safariborder bg-safarigray p-8">
          ...
          <div className="inline-flex flex-col sm:flex-row gap-4">
            ...
            <a href="mailto:hello@safaritech.co.ke" className="border border-safariborder text-gray-700 md:text-gray-300 px-6 py-2.5 rounded-lg font-medium transition-all hover:border-neon hover:text-neon">
              Email Support
            </a>
          </div>
        </div>
