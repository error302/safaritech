  ...
  return (
    <div className="bg-safaridark min-h-screen py-6 md:py-8">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <h1 className="mb-6 md:mb-8 font-display font-bold text-2xl md:text-3xl text-white">My Orders</h1>
        ...
        {isLoading ? (
          <div className="bg-safarigray border border-safariborder rounded-xl p-8 md:p-12 text-center">
            ...
            <h2 className="mb-2 text-lg md:text-xl font-semibold text-white">Loading orders...</h2>
          ...
          <div className="bg-safarigray border border-safariborder rounded-xl p-8 md:p-12 text-center">
            ...
            <h2 className="mb-2 text-lg md:text-xl font-semibold text-white">No orders yet</h2>
            ...
            {orders.map((order) => {
              ...
              return (
                <Link
                  ...
                  className="block bg-safarigray border border-safariborder rounded-xl p-4 md:p-6 hover:border-neon/50 transition-all group"
                >
