      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Complete your purchase through our secure checkout process.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">We verify your payment and prepare your items for shipment within 24 hours.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Receive tracking details via SMS and email. Track your order in real-time.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Your order arrives at your doorstep. Time to enjoy your new gadget!</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="rounded-xl border border-safariborder bg-safarigray p-6 space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Delivery times are estimates and may vary during holidays or due to unforeseen circumstances.</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">All products are packaged securely to prevent damage during transit. Large items may require assembly.</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Please have a valid ID ready when receiving high-value orders (above KSh 50,000).</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex flex-col sm:flex-row gap-4">
            ...
            <a href="/contact" className="border border-safariborder text-gray-700 md:text-gray-300 px-6 py-2.5 rounded-lg font-medium transition-all hover:border-neon hover:text-neon">
              Contact Support
            </a>
          </div>
        </div>
