...
export default function Blog() {
    ...
    return (
      <div className="bg-safaridark min-h-screen py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <div className="h-10 w-64 bg-safarigray rounded animate-pulse mb-4" />
            <div className="h-5 w-96 bg-safarigray rounded animate-pulse" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="rounded-xl border border-safariborder bg-safarigray overflow-hidden">
                <div className="aspect-video bg-safarigray animate-pulse" />
                <div className="p-6 space-y-3">
                  <div className="h-4 w-20 bg-safarigray rounded animate-pulse" />
                  <div className="h-6 w-full bg-safarigray rounded animate-pulse" />
                  <div className="h-4 w-full bg-safarigray rounded animate-pulse" />
                  <div className="flex gap-4 pt-2">
                    <div className="h-4 w-24 bg-safarigray rounded animate-pulse" />
                    <div className="h-4 w-24 bg-safarigray rounded animate-pulse" />
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="bg-safaridark min-h-screen py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="mb-4 text-4xl font-bold font-display text-white">Tech Blog</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {posts.map((post) => (
                <Link
                  key={post.id}
                  href={`/blog/${post.slug}`}
                  className="group rounded-xl border border-safariborder bg-safarigray overflow-hidden transition-all hover:border-electric/50 hover:shadow-lg hover:shadow-electric/10"
                >
...
{post.seoTitle || 'Tech'}
                    ...
                    <h2 className="mb-3 text-xl font-bold group-hover:text-neon transition-colors text-white">
                      {post.title}
                    </h2>
            ...
            {data?.nextCursor && (
              <div className="mt-12 flex justify-center">
                <button className="border border-safariborder text-gray-700 md:text-gray-300 px-5 py-2.5 rounded-lg text-sm font-medium transition-all hover:border-neon hover:text-neon">
                  Load More Articles
                </button>
              </div>
            )}
