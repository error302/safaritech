    ...
    return (
      <div className="bg-safaridark min-h-screen py-16 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-white">Loading order details...</h1>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-safaridark min-h-screen py-16 flex items-center justify-center">
      <div className="mx-auto max-w-md px-4 text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold font-display text-white">Order Confirmed!</h1>
        <p className="text-gray-500 md:text-gray-400 mb-6">
        ...
        <div className="rounded-xl border border-safariborder bg-safarigray p-6 mb-8">
          ...
          {order && (
            <div className="flex items-center justify-between mt-4 pt-4 border-t border-safariborder">
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="flex items-center gap-3 rounded-lg bg-safarigray border border-safariborder p-4 text-left">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href="/shop" className="border border-safariborder text-gray-700 md:text-gray-300 px-5 py-3 rounded-lg font-medium transition-all hover:border-neon hover:text-neon">
            Continue Shopping
          </Link>
        </div>
      </div>
