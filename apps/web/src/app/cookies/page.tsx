    ...
    <div className="md:bg-safaridark bg-gray-50 min-h-screen py-12">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <h1 className="mb-4 text-4xl font-bold font-display text-gray-900 md:text-white">Cookie Policy</h1>
        ...
        <div className="space-y-8 text-gray-600 md:text-gray-400">
          <section className="rounded-xl border border-gray-200 md:border-safariborder bg-white md:bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 md:text-white">What Are Cookies?</h2>
            <p>
          ...
          <section className="rounded-xl border border-gray-200 md:border-safariborder bg-white md:bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 md:text-white">How We Use Cookies</h2>
          ...
          <section className="rounded-xl border border-gray-200 md:border-safariborder bg-white md:bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 md:text-white">Managing Cookies</h2>
            <p className="mb-4">
          ...
          <section className="rounded-xl border border-gray-200 md:border-safariborder bg-white md:bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 md:text-white">Contact</h2>
            <p>
