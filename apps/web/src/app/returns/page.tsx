      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Unopened items, defective products, wrong items delivered, items damaged in transit</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Opened software, personal care products, items without original packaging, clearance/final sale items</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Email hello@safaritech.co.ke or WhatsApp +254 700 000 000 with your order ID and reason for return.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Our team will review your request and provide a Return Merchandise Authorization (RMA) number.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Package the item securely with all original accessories and documentation. We'll arrange free pickup.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Once received and inspected, we'll process your refund within 5-7 business days to your original payment method.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="rounded-xl border border-safariborder bg-safarigray p-6 space-y-4">
              <div className="flex gap-3">
                <span className="text-amber-500 text-xl">⚠️</span>
                <div>
                  <p className="font-medium">Original Condition</p>
                  <p className="text-gray-400">Items must be unused, in original packaging, with all tags and accessories included.</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Return requests must be initiated within 7 days of delivery. No exceptions.</p>
                </div>
              </div>
              <div className="flex gap-3">
                <span className="text-green-500 text-xl">💳</span>
                <div>
                  ...
                  <p className="text-gray-400">Refunds are issued to the original payment method. No cash refunds for card payments.</p>
                </div>
              </div>
              <div className="flex gap-3">
                <span className="text-red-500 text-xl">🚫</span>
                <div>
                  ...
                  <p className="text-gray-400">Original shipping fees are non-refundable unless the product was defective or incorrect.</p>
                </div>
              </div>
            </div>
          </section>
