      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-gray-400">
          <section className="rounded-xl border border-safariborder bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-white">About Safaritech</h2>
            <p className="mb-4">
          ...
          <section className="rounded-xl border border-safariborder bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-white">Media Contact</h2>
          ...
          <section className="rounded-xl border border-safariborder bg-safarigray p-8">
            <h2 className="mb-4 text-2xl font-semibold text-white">Brand Assets</h2>
            <p className="mb-4">
